    ...
    return (
        ...
        <div className="terms-wrap">
            ...
            <div className="long-text">
                ...
                <p>The shipping costs and type of delivery is the subject of written quotation of the Supplier which is not defined in the GTC.</p>
                ...
                <p>The following is not included in the warranty:</p>
                    <ul>
                        ...
                        <li>Any damage caused by transport must be transmitted to the Supplier during the first 48 hours after the reception of the product in order to be able to claim to the transport company. It must be indicated upon reception that the product is not in acceptable condition. If it is not indicated upon reception or after 48 hours, the Supplier cannot be held responsible. Pictures of packaging and product damage must be attached. In the same way, any aesthetic defect or damage that the machine could have from origin, must be transmitted to Bodytone in the first 48 hours.</li>
                    </ul>

                <h4>10. DATA PROTECTION</h4>
                <p>The Supplier guarantees the privacy of the personal data provided, according to the GDPR. The visit to this website does not mean that the user is obliged to provide any information about himself, however during the visit it is possible that personal data will be requested through forms. The User can consult all the information concerning his/her privacy as well as data protection here: <a href="#gdpr-id">Privacy policy</a></p>   
