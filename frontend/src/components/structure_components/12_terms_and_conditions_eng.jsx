    ...
    return (
        ...
        <div className="terms-wrap">
            ...
            <div className="long-text">
                ...
                <p>Contracting through the website/online shop of the Offeror shall imply the acceptance by the User or User of the same, as well as the conditions of use established for the User’s navigation through the websites owned by the Offeror. These conditions shall apply without prejudice to the application of the legal regulations on the subject that may be applicable in each case.</p>
                ...
                {/*<p>The order will be accompanied by the invoice at the time of delivery to the address. In the section “My Orders”, located on the home page in the section “My Account” the User will also find a history of all orders placed with Offeror. By clicking on the order number, the User will find the list of products purchased, the price and the method of payment.</p> */}
                ...
                <p>The ordered products have to be prepaid before delivery according to the invoice issued by the Offeror.</p>

                <h4>8. RETURN POLICY</h4>
                <p>The Farkas Gym product is produced based on firm order from the User therefore the Offeror does not accept return.</p>

                <h4>9. GUARANTEE</h4>
                <p>The warranty is subject to compliance with the conditions of use and maintenance indicated by the Offeror. The Offeror reserves the right to require the necessary documents that justify compliance with these conditions</p>
                <p>The following is not included in the warranty:</p>
                    <ul>
                        <li>Damage caused by the customer's non-observance of the product assembly instructions.</li>
                        <li>Damage caused by poor product conservation, subjecting it to unsuitable conditions (outdoors, excessive humidity).</li>
                        <li>Call-outs from the technical service team due to a customer's lack of knowledge in machine use (not plugging in the product, not knowing how to connect the Wi-Fi, Bluetooth).</li>
                        <li>Any damage caused by transport must be transmitted to the Offeror during the first 48 hours after the reception of the product in order to be able to claim to the transport company. It must be indicated upon reception that the product is not in acceptable condition. If it is not indicated upon reception or after 48 hours, the Offeror cannot be held responsible. Pictures of packaging and product damage must be attached. In the same way, any aesthetic defect or damage that the machine could have from origin, must be transmitted to Bodytone in the first 48 hours.</li>
                    </ul>

                <h4>10. DATA PROTECTION</h4>
                <p>The Offeror guarantees the privacy of the personal data provided, according to the GDPR. The visit to this website does not mean that the user is obliged to provide any information about himself, however during the visit it is possible that personal data will be requested through forms. The User can consult all the information concerning his/her privacy as well as data protection here: <a href="#gdpr-id">Privacy policy</a></p>   
            
                <h4>11. APPLICABLE LEGISLATION AND JURISDICTION</h4>
                <p>The relationship between the User and the Offeror shall be governed by the regulations in force and applicable in Hungarian territory, and the courts of law of the territory in which the Offeror has its registered office shall be competent to decide on any dispute that may arise between the User and the Offeror.</p>
