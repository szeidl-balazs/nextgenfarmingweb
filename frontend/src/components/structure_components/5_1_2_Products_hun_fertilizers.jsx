...
const EventsHun = () => {
    ...
    return (
        ...
        <div className="panel-wrap">
          ...
          <div className="subpanel">
            <div className="panel-text">
                <h2 className="accordion__content">Eurosolids Minto Liquid 27-0-0 MgO + TE</h2>{/*product name*/}
                <h3 className="accordion__content">Folyékony ásványi műtrágya</h3>
                <p className="accordion__content">{/*product highlight*/}  
                A Minto Liquid 27-0-0 MgO + TE egy koncentrált folyékony ásványi trágya magas nitrogén tartalommal, 
                mely mezo- és mikroelemeket is tartalmaz könnyen felvehető EDTA kelát formájában. 
                </p>
